...
:
(
{ before(grammarAccess.getBuildFileAccess().getImportSectionAssignment_1()); }
(rule__BuildFile__ImportSectionAssignment_1)?
{ after(grammarAccess.getBuildFileAccess().getImportSectionAssignment_1()); }
)
...
:
(
{ before(grammarAccess.getBuildFileAccess().getImportSectionXImportSectionParserRuleCall_1_0()); }
	ruleXImportSection{ after(grammarAccess.getBuildFileAccess().getImportSectionXImportSectionParserRuleCall_1_0()); }
)
