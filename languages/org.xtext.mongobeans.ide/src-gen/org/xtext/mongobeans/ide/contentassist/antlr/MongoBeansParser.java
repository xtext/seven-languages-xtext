 ...
 * generated by Xtext
 */
package org.xtext.mongobeans.ide.contentassist.antlr;
...
import org.xtext.mongobeans.ide.contentassist.antlr.internal.InternalMongoBeansParser;
...
public class MongoBeansParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MongoBeansGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MongoBeansGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAbstractElementAccess().getAlternatives(), "rule__AbstractElement__Alternatives");
			builder.put(grammarAccess.getAbstractFeatureAccess().getAlternatives(), "rule__AbstractFeature__Alternatives");
			builder.put(grammarAccess.getMongoPropertyAccess().getAlternatives_0(), "rule__MongoProperty__Alternatives_0");
			...
			builder.put(grammarAccess.getMongoFileAccess().getGroup(), "rule__MongoFile__Group__0");
			builder.put(grammarAccess.getPackageDeclarationAccess().getGroup(), "rule__PackageDeclaration__Group__0");
			builder.put(grammarAccess.getMongoBeanAccess().getGroup(), "rule__MongoBean__Group__0");
			builder.put(grammarAccess.getMongoPropertyAccess().getGroup(), "rule__MongoProperty__Group__0");
			builder.put(grammarAccess.getMongoOperationAccess().getGroup(), "rule__MongoOperation__Group__0");
			builder.put(grammarAccess.getMongoOperationAccess().getGroup_0(), "rule__MongoOperation__Group_0__0");
			builder.put(grammarAccess.getMongoOperationAccess().getGroup_0_0(), "rule__MongoOperation__Group_0_0__0");
			builder.put(grammarAccess.getMongoOperationAccess().getGroup_1(), "rule__MongoOperation__Group_1__0");
			builder.put(grammarAccess.getMongoOperationAccess().getGroup_1_1(), "rule__MongoOperation__Group_1_1__0");
			...
			builder.put(grammarAccess.getMongoFileAccess().getImportSectionAssignment_0(), "rule__MongoFile__ImportSectionAssignment_0");
			builder.put(grammarAccess.getMongoFileAccess().getElementsAssignment_1(), "rule__MongoFile__ElementsAssignment_1");
			...
			builder.put(grammarAccess.getMongoBeanAccess().getNameAssignment_0(), "rule__MongoBean__NameAssignment_0");
			builder.put(grammarAccess.getMongoBeanAccess().getFeaturesAssignment_2(), "rule__MongoBean__FeaturesAssignment_2");
			builder.put(grammarAccess.getMongoPropertyAccess().getTypeAssignment_0_0(), "rule__MongoProperty__TypeAssignment_0_0");
			builder.put(grammarAccess.getMongoPropertyAccess().getInlineTypeAssignment_0_1(), "rule__MongoProperty__InlineTypeAssignment_0_1");
			builder.put(grammarAccess.getMongoPropertyAccess().getManyAssignment_1(), "rule__MongoProperty__ManyAssignment_1");
			builder.put(grammarAccess.getMongoPropertyAccess().getNameAssignment_2(), "rule__MongoProperty__NameAssignment_2");
			builder.put(grammarAccess.getMongoOperationAccess().getReturnTypeAssignment_0_0_0(), "rule__MongoOperation__ReturnTypeAssignment_0_0_0");
			builder.put(grammarAccess.getMongoOperationAccess().getNameAssignment_0_0_1(), "rule__MongoOperation__NameAssignment_0_0_1");
			builder.put(grammarAccess.getMongoOperationAccess().getParametersAssignment_1_0(), "rule__MongoOperation__ParametersAssignment_1_0");
			builder.put(grammarAccess.getMongoOperationAccess().getParametersAssignment_1_1_1(), "rule__MongoOperation__ParametersAssignment_1_1_1");
			builder.put(grammarAccess.getMongoOperationAccess().getBodyAssignment_3(), "rule__MongoOperation__BodyAssignment_3");
	...
	@Override
	protected InternalMongoBeansParser createParser() {
		InternalMongoBeansParser result = new InternalMongoBeansParser(null);
