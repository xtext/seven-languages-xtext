			...
			(
				...
				lv_params_5_0=ruleParameter
				{
					...
					add(
						...
						"params",
						lv_params_5_0,
						"org.xtext.template.Template.Parameter");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_body_6_0=ruleRichString
				{
					...
					set(
						...
						"body",
						lv_body_6_0,
						"org.xtext.template.Template.RichString");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_expressions_1_0=ruleRichStringLiteral
				{
					...
					add(
						...
						"expressions",
						lv_expressions_1_0,
						"org.xtext.template.Template.RichStringLiteral");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_expressions_2_0=ruleRichStringPart
					{
						...
						add(
							...
							"expressions",
							lv_expressions_2_0,
							"org.xtext.template.Template.RichStringPart");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"value",
						lv_value_1_0,
						"org.xtext.template.Template.TEXT");
				}
			)
		)
	)
				...
				(
					...
					lv_else_4_0=ruleRichStringElseIf
					{
						...
						set(
							...
							"else",
							lv_else_4_0,
							"org.xtext.template.Template.RichStringElseIf");
						afterParserOrEnumRuleCall();
					}
				)
			)
