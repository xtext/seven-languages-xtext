		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMongoFileAccess().getGroup(), "rule__MongoFile__Group__0");
					...
					put(grammarAccess.getMongoFileAccess().getImportSectionAssignment_0(), "rule__MongoFile__ImportSectionAssignment_0");
					put(grammarAccess.getMongoFileAccess().getElementsAssignment_1(), "rule__MongoFile__ElementsAssignment_1");
