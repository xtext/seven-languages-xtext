...
{ before(grammarAccess.getMongoFileAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
	ruleXImportSection{ after(grammarAccess.getMongoFileAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
)
...
{ before(grammarAccess.getMongoFileAccess().getElementsAbstractElementParserRuleCall_1_0()); }
	ruleAbstractElement{ after(grammarAccess.getMongoFileAccess().getElementsAbstractElementParserRuleCall_1_0()); }
)
