...
import org.xtext.mongobeans.ide.contentassist.antlr.MongoBeansParser;
import org.xtext.mongobeans.ide.contentassist.antlr.PartialMongoBeansContentAssistParser;
import org.xtext.mongobeans.ide.contentassist.antlr.internal.InternalMongoBeansLexer;
import org.xtext.mongobeans.ui.contentassist.MongoBeansProposalProvider;
import org.xtext.mongobeans.ui.editor.MongoBeansEditor;
import org.xtext.mongobeans.ui.labeling.MongoBeansDescriptionLabelProvider;
...
import org.xtext.mongobeans.validation.MongoBeansValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link MongoBeansUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractMongoBeansUiModule extends DefaultXbaseUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.mongobeans.parser.antlr.internal.InternalMongoBeansLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalMongoBeansLexer.class).toProvider(LexerProvider.create(InternalMongoBeansLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return MongoBeansValidatorConfigurationBlock.class;
	}
	...
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(MongoBeansDescriptionLabelProvider.class);
	}
	...
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return MongoBeansProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialMongoBeansContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("MongoBeans Compare");
	}
