...
public class TortoiseShellValidatorConfigurationBlock extends XbaseValidationConfigurationBlock {

	@Override
	protected void fillSettingsPage(Composite composite, int nColumns, int defaultIndent) {
		addComboBox(TortoiseShellConfigurableIssueCodesProvider.DEPRECATED_MODEL_PART, "Deprecated Model Part", composite, defaultIndent);
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("TortoiseShell");
		if (section == null) {
			return dialogSettings.addNewSection("TortoiseShell");
		}
		return section;
	}
}
