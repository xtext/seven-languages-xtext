 ...
 */
package org.xtext.guicemodules.ide.contentassist.antlr;
...
import org.xtext.guicemodules.ide.contentassist.antlr.internal.InternalGuiceModulesParser;
...
public class GuiceModulesParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(GuiceModulesGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GuiceModulesGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getBindingASTAccess().getAlternatives_2(), "rule__BindingAST__Alternatives_2");
			...
			builder.put(grammarAccess.getModulesASTAccess().getGroup(), "rule__ModulesAST__Group__0");
			builder.put(grammarAccess.getModuleASTAccess().getGroup(), "rule__ModuleAST__Group__0");
			builder.put(grammarAccess.getModuleASTAccess().getGroup_1(), "rule__ModuleAST__Group_1__0");
			builder.put(grammarAccess.getModuleASTAccess().getGroup_1_2(), "rule__ModuleAST__Group_1_2__0");
			builder.put(grammarAccess.getBindingASTAccess().getGroup(), "rule__BindingAST__Group__0");
			builder.put(grammarAccess.getBindingASTAccess().getGroup_2_0(), "rule__BindingAST__Group_2_0__0");
			builder.put(grammarAccess.getBindingASTAccess().getGroup_2_1(), "rule__BindingAST__Group_2_1__0");
			builder.put(grammarAccess.getKeyASTAccess().getGroup(), "rule__KeyAST__Group__0");
			...
			builder.put(grammarAccess.getModulesASTAccess().getImportSectionAssignment_0(), "rule__ModulesAST__ImportSectionAssignment_0");
			builder.put(grammarAccess.getModulesASTAccess().getModulesAssignment_1(), "rule__ModulesAST__ModulesAssignment_1");
			builder.put(grammarAccess.getModuleASTAccess().getNameAssignment_0(), "rule__ModuleAST__NameAssignment_0");
			builder.put(grammarAccess.getModuleASTAccess().getMixinsAssignment_1_1(), "rule__ModuleAST__MixinsAssignment_1_1");
			builder.put(grammarAccess.getModuleASTAccess().getMixinsAssignment_1_2_1(), "rule__ModuleAST__MixinsAssignment_1_2_1");
			builder.put(grammarAccess.getModuleASTAccess().getBindingsAssignment_3(), "rule__ModuleAST__BindingsAssignment_3");
			builder.put(grammarAccess.getBindingASTAccess().getFromAssignment_1(), "rule__BindingAST__FromAssignment_1");
			builder.put(grammarAccess.getBindingASTAccess().getToAssignment_2_0_1(), "rule__BindingAST__ToAssignment_2_0_1");
			builder.put(grammarAccess.getBindingASTAccess().getToInstanceAssignment_2_1_1(), "rule__BindingAST__ToInstanceAssignment_2_1_1");
			builder.put(grammarAccess.getKeyASTAccess().getAnnotationAssignment_0(), "rule__KeyAST__AnnotationAssignment_0");
			builder.put(grammarAccess.getKeyASTAccess().getTypeAssignment_1(), "rule__KeyAST__TypeAssignment_1");
	...
	@Override
	protected InternalGuiceModulesParser createParser() {
		InternalGuiceModulesParser result = new InternalGuiceModulesParser(null);
