 ...
 ******************************************************************************/
package org.xtext.guicemodules.ui.contentassist.antlr;
...
public class GuiceModulesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.guicemodules.ui.contentassist.antlr.internal.InternalGuiceModulesParser createParser() {
		org.xtext.guicemodules.ui.contentassist.antlr.internal.InternalGuiceModulesParser result = new org.xtext.guicemodules.ui.contentassist.antlr.internal.InternalGuiceModulesParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModulesASTAccess().getImportSectionAssignment_0(), "rule__ModulesAST__ImportSectionAssignment_0");
