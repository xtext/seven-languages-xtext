 ...
 */
package org.xtext.tortoiseshell.ide.contentassist.antlr;
...
import org.xtext.tortoiseshell.ide.contentassist.antlr.internal.InternalTortoiseShellParser;
...
public class TortoiseShellParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(TortoiseShellGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TortoiseShellGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getExecutableAccess().getAlternatives(), "rule__Executable__Alternatives");
			...
			builder.put(grammarAccess.getSubProgramAccess().getGroup(), "rule__SubProgram__Group__0");
			builder.put(grammarAccess.getSubProgramAccess().getGroup_2(), "rule__SubProgram__Group_2__0");
			...
			builder.put(grammarAccess.getProgramAccess().getBodyAssignment_0(), "rule__Program__BodyAssignment_0");
			builder.put(grammarAccess.getProgramAccess().getSubProgramsAssignment_1(), "rule__Program__SubProgramsAssignment_1");
			builder.put(grammarAccess.getSubProgramAccess().getNameAssignment_1(), "rule__SubProgram__NameAssignment_1");
			builder.put(grammarAccess.getSubProgramAccess().getReturnTypeAssignment_2_1(), "rule__SubProgram__ReturnTypeAssignment_2_1");
			builder.put(grammarAccess.getSubProgramAccess().getParametersAssignment_3(), "rule__SubProgram__ParametersAssignment_3");
			builder.put(grammarAccess.getSubProgramAccess().getBodyAssignment_4(), "rule__SubProgram__BodyAssignment_4");
			builder.put(grammarAccess.getBodyAccess().getExpressionsAssignment_2_0(), "rule__Body__ExpressionsAssignment_2_0");
	...
	@Override
	protected InternalTortoiseShellParser createParser() {
		InternalTortoiseShellParser result = new InternalTortoiseShellParser(null);
