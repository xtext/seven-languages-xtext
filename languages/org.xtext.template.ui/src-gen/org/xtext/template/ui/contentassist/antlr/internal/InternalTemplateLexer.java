...
public class InternalTemplateLexer extends Lexer {
    ...
    public final void mRULE_TEXT() throws RecognitionException {
        try {
            int _type = RULE_TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23083:11: ( '\\u00BB' (~ ( '\\u00AB' ) )* ( EOF | '\\u00AB' ) )
            // InternalTemplate.g:23083:13: '\\u00BB' (~ ( '\\u00AB' ) )* ( EOF | '\\u00AB' )
            {
            match('\u00BB'); 
            // InternalTemplate.g:23083:22: (~ ( '\\u00AB' ) )*
            loop1:
            do {
                int alt1=2;
            ...
            // InternalTemplate.g:23083:35: ( EOF | '\\u00AB' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalTemplate.g:23083:36: EOF
                    {
                    match(EOF); 
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23085:10: ( ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )? )
            // InternalTemplate.g:23085:12: ( '0x' | '0X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+ ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
            {
            // InternalTemplate.g:23085:12: ( '0x' | '0X' )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalTemplate.g:23085:13: '0x'
                    {
                    match("0x"); 
                    ...
                    break;
                case 2 :
                    // InternalTemplate.g:23085:18: '0X'
                    {
                    match("0X"); 
            ...
            // InternalTemplate.g:23085:24: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' | '_' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
            ...
            // InternalTemplate.g:23085:58: ( '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) ) )?
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalTemplate.g:23085:59: '#' ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
                    {
                    match('#'); 
                    // InternalTemplate.g:23085:63: ( ( 'b' | 'B' ) ( 'i' | 'I' ) | ( 'l' | 'L' ) )
                    int alt5=2;
                    ...
                    switch (alt5) {
                        case 1 :
                            // InternalTemplate.g:23085:64: ( 'b' | 'B' ) ( 'i' | 'I' )
                            {
                            ...
                            break;
                        case 2 :
                            // InternalTemplate.g:23085:84: ( 'l' | 'L' )
                            {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23087:10: ( '0' .. '9' ( '0' .. '9' | '_' )* )
            // InternalTemplate.g:23087:12: '0' .. '9' ( '0' .. '9' | '_' )*
            {
            matchRange('0','9'); 
            // InternalTemplate.g:23087:21: ( '0' .. '9' | '_' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_DECIMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23089:14: ( RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )? )
            // InternalTemplate.g:23089:16: RULE_INT ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )? ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
            {
            mRULE_INT(); 
            // InternalTemplate.g:23089:25: ( ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalTemplate.g:23089:26: ( 'e' | 'E' ) ( '+' | '-' )? RULE_INT
                    {
            ...
            // InternalTemplate.g:23089:58: ( ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' ) | ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' ) )?
            int alt10=3;
            ...
            switch (alt10) {
                case 1 :
                    // InternalTemplate.g:23089:59: ( 'b' | 'B' ) ( 'i' | 'I' | 'd' | 'D' )
                    {
                    if ( input.LA(1)=='B'||input.LA(1)=='b' ) {
                        input.consume();
                    ...
                    break;
                case 2 :
                    // InternalTemplate.g:23089:87: ( 'l' | 'L' | 'd' | 'D' | 'f' | 'F' )
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23091:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )* )
            // InternalTemplate.g:23091:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
            {
            // InternalTemplate.g:23091:11: ( '^' )?
            int alt11=2;
            ...
            // InternalTemplate.g:23091:44: ( 'a' .. 'z' | 'A' .. 'Z' | '$' | '_' | '0' .. '9' )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23093:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? ) )
            // InternalTemplate.g:23093:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
            {
            // InternalTemplate.g:23093:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )? | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )? )
            int alt17=2;
            ...
            switch (alt17) {
                case 1 :
                    // InternalTemplate.g:23093:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* ( '\"' )?
                    {
                    match('\"'); 
                    // InternalTemplate.g:23093:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
                    ...
                    break;
                case 2 :
                    // InternalTemplate.g:23093:49: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* ( '\\'' )?
                    {
                    match('\''); 
                    // InternalTemplate.g:23093:54: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop15:
                    do {
                        int alt15=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23095:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTemplate.g:23095:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTemplate.g:23095:24: ( options {greedy=false; } : . )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23097:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTemplate.g:23097:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalTemplate.g:23097:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23099:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTemplate.g:23099:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTemplate.g:23099:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt22=0;
            loop22:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTemplate.g:23101:16: ( . )
            // InternalTemplate.g:23101:18: .
            {
            matchAny(); 
