 ...
 ******************************************************************************/
package org.xtext.template.ui.contentassist.antlr;
...
public class TemplateParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.template.ui.contentassist.antlr.internal.InternalTemplateParser createParser() {
		org.xtext.template.ui.contentassist.antlr.internal.InternalTemplateParser result = new org.xtext.template.ui.contentassist.antlr.internal.InternalTemplateParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTemplateFileAccess().getGroup(), "rule__TemplateFile__Group__0");
					...
					put(grammarAccess.getRichStringIfAccess().getGroup_4_1(), "rule__RichStringIf__Group_4_1__0");
					put(grammarAccess.getRichStringElseIfAccess().getGroup(), "rule__RichStringElseIf__Group__0");
					put(grammarAccess.getRichStringElseIfAccess().getGroup_4_1(), "rule__RichStringElseIf__Group_4_1__0");
					...
					put(grammarAccess.getTemplateFileAccess().getPackageAssignment_2_1(), "rule__TemplateFile__PackageAssignment_2_1");
					put(grammarAccess.getTemplateFileAccess().getImportsAssignment_3(), "rule__TemplateFile__ImportsAssignment_3");
					put(grammarAccess.getTemplateFileAccess().getParamsAssignment_4(), "rule__TemplateFile__ParamsAssignment_4");
					...
					put(grammarAccess.getRichStringIfAccess().getElseAssignment_4_0(), "rule__RichStringIf__ElseAssignment_4_0");
					put(grammarAccess.getRichStringIfAccess().getElseAssignment_4_1_1(), "rule__RichStringIf__ElseAssignment_4_1_1");
					...
					put(grammarAccess.getRichStringElseIfAccess().getElseAssignment_4_0(), "rule__RichStringElseIf__ElseAssignment_4_0");
					put(grammarAccess.getRichStringElseIfAccess().getElseAssignment_4_1_1(), "rule__RichStringElseIf__ElseAssignment_4_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.template.ui.contentassist.antlr.internal.InternalTemplateParser typedParser = (org.xtext.template.ui.contentassist.antlr.internal.InternalTemplateParser) parser;
			typedParser.entryRuleTemplateFile();
