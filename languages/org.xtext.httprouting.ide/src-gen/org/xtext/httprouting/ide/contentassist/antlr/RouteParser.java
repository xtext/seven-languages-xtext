 ...
 */
package org.xtext.httprouting.ide.contentassist.antlr;
...
import org.xtext.httprouting.ide.contentassist.antlr.internal.InternalRouteParser;
...
public class RouteParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(RouteGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RouteGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAbstractDeclarationAccess().getAlternatives(), "rule__AbstractDeclaration__Alternatives");
			builder.put(grammarAccess.getURLAccess().getAlternatives_1(), "rule__URL__Alternatives_1");
			builder.put(grammarAccess.getURLAccess().getAlternatives_1_1_0_1(), "rule__URL__Alternatives_1_1_0_1");
			...
			builder.put(grammarAccess.getRequestTypeAccess().getAlternatives(), "rule__RequestType__Alternatives");
			...
			builder.put(grammarAccess.getRouteAccess().getGroup_2(), "rule__Route__Group_2__0");
			...
			builder.put(grammarAccess.getURLAccess().getGroup_1_1_0(), "rule__URL__Group_1_1_0__0");
			builder.put(grammarAccess.getURLAccess().getGroup_1_1_1(), "rule__URL__Group_1_1_1__0");
			...
			builder.put(grammarAccess.getModelAccess().getDeclarationsAssignment_1(), "rule__Model__DeclarationsAssignment_1");
			builder.put(grammarAccess.getDependencyAccess().getAnnotationsAssignment_1(), "rule__Dependency__AnnotationsAssignment_1");
			builder.put(grammarAccess.getDependencyAccess().getTypeAssignment_2(), "rule__Dependency__TypeAssignment_2");
			builder.put(grammarAccess.getDependencyAccess().getNameAssignment_3(), "rule__Dependency__NameAssignment_3");
			builder.put(grammarAccess.getRouteAccess().getRequestTypeAssignment_0(), "rule__Route__RequestTypeAssignment_0");
			builder.put(grammarAccess.getRouteAccess().getUrlAssignment_1(), "rule__Route__UrlAssignment_1");
			builder.put(grammarAccess.getRouteAccess().getConditionAssignment_2_1(), "rule__Route__ConditionAssignment_2_1");
			builder.put(grammarAccess.getRouteAccess().getCallAssignment_4(), "rule__Route__CallAssignment_4");
			builder.put(grammarAccess.getURLAccess().getVariablesAssignment_1_1_0_1_1(), "rule__URL__VariablesAssignment_1_1_0_1_1");
			builder.put(grammarAccess.getURLAccess().getVariablesAssignment_1_1_1_1(), "rule__URL__VariablesAssignment_1_1_1_1");
			builder.put(grammarAccess.getURLAccess().getWildcardAssignment_1_1_1_2(), "rule__URL__WildcardAssignment_1_1_1_2");
	...
	@Override
	protected InternalRouteParser createParser() {
		InternalRouteParser result = new InternalRouteParser(null);
