 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.mongobeans.mongoBeans.impl.AbstractElementImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractElementImpl extends MinimalEObjectImpl.Container implements AbstractElement
{
  ...
  {
    return MongoBeansPackage.Literals.ABSTRACT_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MongoBeansPackage.ABSTRACT_ELEMENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MongoBeansPackage.ABSTRACT_ELEMENT__NAME:
        return getName();
    }
