 ...
 */
package org.xtext.builddsl.ide.contentassist.antlr;
...
import org.xtext.builddsl.ide.contentassist.antlr.internal.InternalBuildDSLParser;
...
public class BuildDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(BuildDSLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BuildDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBuildFileAccess().getGroup(), "rule__BuildFile__Group__0");
			builder.put(grammarAccess.getBuildFileAccess().getGroup_0(), "rule__BuildFile__Group_0__0");
			...
			builder.put(grammarAccess.getBuildFileAccess().getNameAssignment_0_1(), "rule__BuildFile__NameAssignment_0_1");
			builder.put(grammarAccess.getBuildFileAccess().getImportSectionAssignment_1(), "rule__BuildFile__ImportSectionAssignment_1");
			builder.put(grammarAccess.getBuildFileAccess().getDeclarationsAssignment_2(), "rule__BuildFile__DeclarationsAssignment_2");
			...
			builder.put(grammarAccess.getParameterAccess().getInitAssignment_3_1(), "rule__Parameter__InitAssignment_3_1");
			builder.put(grammarAccess.getTaskAccess().getNameAssignment_1(), "rule__Task__NameAssignment_1");
			builder.put(grammarAccess.getTaskAccess().getDependsAssignment_2_1(), "rule__Task__DependsAssignment_2_1");
			builder.put(grammarAccess.getTaskAccess().getDependsAssignment_2_2_1(), "rule__Task__DependsAssignment_2_2_1");
			builder.put(grammarAccess.getTaskAccess().getActionAssignment_3(), "rule__Task__ActionAssignment_3");
	...
	@Override
	protected InternalBuildDSLParser createParser() {
		InternalBuildDSLParser result = new InternalBuildDSLParser(null);
