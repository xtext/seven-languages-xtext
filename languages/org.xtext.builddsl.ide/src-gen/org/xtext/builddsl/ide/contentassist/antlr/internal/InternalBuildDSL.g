...
:
	(
		...
		ruleQualifiedName
		{ after(grammarAccess.getBuildFileAccess().getNameQualifiedNameParserRuleCall_0_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleXImportSection
		{ after(grammarAccess.getBuildFileAccess().getImportSectionXImportSectionParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleDeclaration
		{ after(grammarAccess.getBuildFileAccess().getDeclarationsDeclarationParserRuleCall_2_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleXExpression
		{ after(grammarAccess.getParameterAccess().getInitXExpressionParserRuleCall_3_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleValidID
		{ after(grammarAccess.getTaskAccess().getNameValidIDParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleXBlockExpression
		{ after(grammarAccess.getTaskAccess().getActionXBlockExpressionParserRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
