 ...
 ******************************************************************************/
package org.xtext.httprouting.ui.contentassist.antlr;
...
public class RouteParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.httprouting.ui.contentassist.antlr.internal.InternalRouteParser createParser() {
		org.xtext.httprouting.ui.contentassist.antlr.internal.InternalRouteParser result = new org.xtext.httprouting.ui.contentassist.antlr.internal.InternalRouteParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDependencyAccess().getTypeAssignment_2(), "rule__Dependency__TypeAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.httprouting.ui.contentassist.antlr.internal.InternalRouteParser typedParser = (org.xtext.httprouting.ui.contentassist.antlr.internal.InternalRouteParser) parser;
