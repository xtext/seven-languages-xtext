 ...
 */
class BuildDSLRuntimeModule extends org.xtext.builddsl.AbstractBuildDSLRuntimeModule {
	@SingletonBinding(eager=true) 
	def Class<? extends BuildDSLValidator> bindValidator() {
		return BuildDSLValidator
	}
