...
public class TortoiseShellSyntacticSequencer extends AbstractSyntacticSequencer {

	protected TortoiseShellGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (TortoiseShellGrammarAccess) access;
