package org.xtext.tortoiseshell.serializer;
...
public class TortoiseShellSemanticSequencer extends XbaseSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == TortoiseShellPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XbasePackage.XBLOCK_EXPRESSION:
				if(context == grammarAccess.getBodyRule()) {
					sequence_Body(context, (XBlockExpression) semanticObject); 
					return; 
				}
	 ...
	 */
	protected void sequence_Body(EObject context, XBlockExpression semanticObject) {
