	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRouteAccess().getAlternatives_3(), "rule__Route__Alternatives_3");
					put(grammarAccess.getURLAccess().getAlternatives_2(), "rule__URL__Alternatives_2");
					put(grammarAccess.getURLAccess().getAlternatives_3_1(), "rule__URL__Alternatives_3_1");
					put(grammarAccess.getRouteFeatureCallAccess().getAlternatives_4_1(), "rule__RouteFeatureCall__Alternatives_4_1");
					...
					put(grammarAccess.getRouteAccess().getGroup_3_0(), "rule__Route__Group_3_0__0");
					put(grammarAccess.getURLAccess().getGroup(), "rule__URL__Group__0");
					put(grammarAccess.getURLAccess().getGroup_2_0(), "rule__URL__Group_2_0__0");
					put(grammarAccess.getURLAccess().getGroup_2_0_1(), "rule__URL__Group_2_0_1__0");
					put(grammarAccess.getURLAccess().getGroup_3(), "rule__URL__Group_3__0");
					put(grammarAccess.getURLAccess().getGroup_3_1_0(), "rule__URL__Group_3_1_0__0");
					put(grammarAccess.getURLAccess().getGroup_3_1_0_1(), "rule__URL__Group_3_1_0_1__0");
					put(grammarAccess.getVariableAccess().getGroup(), "rule__Variable__Group__0");
					put(grammarAccess.getConditionAccess().getGroup(), "rule__Condition__Group__0");
					put(grammarAccess.getKeyAccess().getGroup(), "rule__Key__Group__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup(), "rule__RouteFeatureCall__Group__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_2(), "rule__RouteFeatureCall__Group_2__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_2_2(), "rule__RouteFeatureCall__Group_2_2__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_4(), "rule__RouteFeatureCall__Group_4__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_4_1_1(), "rule__RouteFeatureCall__Group_4_1_1__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_4_1_1_1(), "rule__RouteFeatureCall__Group_4_1_1_1__0");
					...
					put(grammarAccess.getRouteAccess().getCallAssignment_3_0_1(), "rule__Route__CallAssignment_3_0_1");
					put(grammarAccess.getRouteAccess().getCallAssignment_3_1(), "rule__Route__CallAssignment_3_1");
					put(grammarAccess.getURLAccess().getVariablesAssignment_2_1(), "rule__URL__VariablesAssignment_2_1");
					put(grammarAccess.getURLAccess().getVariablesAssignment_3_1_1(), "rule__URL__VariablesAssignment_3_1_1");
					put(grammarAccess.getVariableAccess().getNameAssignment_1(), "rule__Variable__NameAssignment_1");
					put(grammarAccess.getVariableAccess().getWildcardAssignment_2(), "rule__Variable__WildcardAssignment_2");
					...
					put(grammarAccess.getRouteFeatureCallAccess().getTypeArgumentsAssignment_2_1(), "rule__RouteFeatureCall__TypeArgumentsAssignment_2_1");
					put(grammarAccess.getRouteFeatureCallAccess().getTypeArgumentsAssignment_2_2_1(), "rule__RouteFeatureCall__TypeArgumentsAssignment_2_2_1");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureAssignment_3(), "rule__RouteFeatureCall__FeatureAssignment_3");
					put(grammarAccess.getRouteFeatureCallAccess().getExplicitOperationCallAssignment_4_0(), "rule__RouteFeatureCall__ExplicitOperationCallAssignment_4_0");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_4_1_0(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_4_1_0");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_4_1_1_0(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_4_1_1_0");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_4_1_1_1_1(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_4_1_1_1_1");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_5(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_5");
