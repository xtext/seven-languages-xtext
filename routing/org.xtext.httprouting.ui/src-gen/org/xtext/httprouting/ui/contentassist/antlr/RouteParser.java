		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getURLAccess().getGroup_1_1_0_1(), "rule__URL__Group_1_1_0_1__0");
					...
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_2_1(), "rule__RouteFeatureCall__Group_2_1__0");
					put(grammarAccess.getRouteFeatureCallAccess().getGroup_2_1_1(), "rule__RouteFeatureCall__Group_2_1_1__0");
					...
					put(grammarAccess.getRouteAccess().getCallAssignment_3_0_2(), "rule__Route__CallAssignment_3_0_2");
					...
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureAssignment_1(), "rule__RouteFeatureCall__FeatureAssignment_1");
					put(grammarAccess.getRouteFeatureCallAccess().getExplicitOperationCallAssignment_2_0(), "rule__RouteFeatureCall__ExplicitOperationCallAssignment_2_0");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_2_1_0(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_2_1_0");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_2_1_1_1(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_2_1_1_1");
					put(grammarAccess.getRouteFeatureCallAccess().getFeatureCallArgumentsAssignment_3(), "rule__RouteFeatureCall__FeatureCallArgumentsAssignment_3");
