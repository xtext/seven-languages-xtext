package org.xtext.simple.serializer;
...
public class SimpleExpressionsSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == SimpleExpressionsPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case SimpleExpressionsPackage.APPLICATION:
	...
	protected void sequence_Application(EObject context, Application semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, SimpleExpressionsPackage.Literals.APPLICATION__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimpleExpressionsPackage.Literals.APPLICATION__NAME));
			if(transientValues.isValueTransient(semanticObject, SimpleExpressionsPackage.Literals.APPLICATION__MAIN) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimpleExpressionsPackage.Literals.APPLICATION__MAIN));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getApplicationAccess().getNameQualifiedNameParserRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getApplicationAccess().getMainMainParserRuleCall_2_0(), semanticObject.getMain());
		feeder.finish();
	}
