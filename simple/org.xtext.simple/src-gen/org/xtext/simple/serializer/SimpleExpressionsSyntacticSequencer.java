...
public class SimpleExpressionsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SimpleExpressionsGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (SimpleExpressionsGrammarAccess) access;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Main_SemicolonKeyword_1_1_q.equals(syntax))
