...
/**
 * Manual modifications go to {org.xtext.simple.SimpleExpressionsRuntimeModule}
 */
...
public abstract class AbstractSimpleExpressionsRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/xtext/simple/SimpleExpressions.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.xtext.simple.SimpleExpressions");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.xtext.simple.services.SimpleExpressionsGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.xtext.simple.serializer.SimpleExpressionsSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.xtext.simple.serializer.SimpleExpressionsSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.xtext.simple.parser.antlr.SimpleExpressionsParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.xtext.simple.parser.antlr.SimpleExpressionsAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.xtext.simple.parser.antlr.internal.InternalSimpleExpressionsLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.xtext.simple.parser.antlr.internal.InternalSimpleExpressionsLexer> provideInternalSimpleExpressionsLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.xtext.simple.parser.antlr.internal.InternalSimpleExpressionsLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.xtext.simple.parser.antlr.internal.InternalSimpleExpressionsLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.xtext.simple.jvmmodel.SimpleExpressionsJvmModelInferrer.class;
	}
