...
* generated by Xtext
*/
package org.xtext.simple.ui.contentassist.antlr;
...
public class SimpleExpressionsParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.simple.ui.contentassist.antlr.internal.InternalSimpleExpressionsParser createParser() {
		org.xtext.simple.ui.contentassist.antlr.internal.InternalSimpleExpressionsParser result = new org.xtext.simple.ui.contentassist.antlr.internal.InternalSimpleExpressionsParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getApplicationAccess().getMainAssignment_2(), "rule__Application__MainAssignment_2");
					put(grammarAccess.getMainAccess().getExpressionsAssignment_1_0(), "rule__Main__ExpressionsAssignment_1_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.simple.ui.contentassist.antlr.internal.InternalSimpleExpressionsParser typedParser = (org.xtext.simple.ui.contentassist.antlr.internal.InternalSimpleExpressionsParser) parser;
