...
public class SimpleForStatement {
  public SimpleForStatement() {
  }
  
  public SimpleForStatement(final SimpleForStatement other) {
  }
  ...
  public String generate(final Procedure1<SimpleForStatement> init) {
    try {
      SimpleForStatement tpl = getClass().getConstructor(getClass()).newInstance(this);
      init.apply(tpl);
      return tpl.generate();
    } catch(Exception e) {
