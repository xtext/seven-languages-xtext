package org.xtext.template.serializer;
...
public class TemplateSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, TemplatePackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TemplatePackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
