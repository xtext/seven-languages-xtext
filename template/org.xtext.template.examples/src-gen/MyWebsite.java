...
public class MyWebsite {
  ...
  private CharSequence generate() {
    ...
    _appendable.append("-->\n<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n\t<meta charset=\"utf-8\">\n\t<title>");
    _appendable.append(this.title);
    _appendable.append("</title>\n\t<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n\t<meta name=\"description\"\n\t\tcontent=\"");
    _appendable.append(this.description);
    _appendable.append("\">\n\t<meta name=\"author\" content=\"");
    _appendable.append(this.author);
    _appendable.append("\">\n</head>\n<body>\n");
    ...
    for (final Section element : this.sections) {
      ...
      _appendable_1.append("\n\t<div class=\"section\">\n\t\t<h1>");
      String _title = element.getTitle();
      _appendable_1.append(_title);
      _appendable_1.append("</h1>\n\t\t");
      ...
      if (_notEquals) {
        ...
        _appendable_2.append("\n\t\t\t<p>");
        String _description_1 = element.getDescription();
        _appendable_2.append(_description_1);
        _appendable_2.append("</p>\n\t\t");
        _richstringif = _appendable_2;
      }
      _appendable_1.append(_richstringif);
      _appendable_1.append("\n\t\t<p>");
      String _body = element.getBody();
      _appendable_1.append(_body);
      _appendable_1.append("</p>\n\t</div>\n");
      _forLoopResult.append(_appendable_1);
    }
    _appendable.append(_forLoopResult);
    _appendable.append("\n</body>\n</html>");
    return _appendable;
  }
