		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBlockStmtAccess().getAlternatives_1(), "rule__BlockStmt__Alternatives_1");
					put(grammarAccess.getStructuralStmtAccess().getAlternatives(), "rule__StructuralStmt__Alternatives");
					put(grammarAccess.getIfStmtAccess().getAlternatives_3(), "rule__IfStmt__Alternatives_3");
					put(grammarAccess.getTextStmtStmtAccess().getTextAlternatives_0(), "rule__TextStmtStmt__TextAlternatives_0");
					put(grammarAccess.getTextStmtExpAccess().getTextAlternatives_0(), "rule__TextStmtExp__TextAlternatives_0");
					...
					put(grammarAccess.getTemplateFileAccess().getGroup_1(), "rule__TemplateFile__Group_1__0");
					...
					put(grammarAccess.getBlockStmtAccess().getGroup(), "rule__BlockStmt__Group__0");
					put(grammarAccess.getBlockStmtAccess().getGroup_1_0(), "rule__BlockStmt__Group_1_0__0");
					put(grammarAccess.getBlockStmtAccess().getGroup_1_1(), "rule__BlockStmt__Group_1_1__0");
					...
					put(grammarAccess.getIfStmtAccess().getGroup_2(), "rule__IfStmt__Group_2__0");
					put(grammarAccess.getIfStmtAccess().getGroup_3_1(), "rule__IfStmt__Group_3_1__0");
					put(grammarAccess.getIfStmtBodyAccess().getGroup(), "rule__IfStmtBody__Group__0");
					...
					put(grammarAccess.getTemplateFileAccess().getPackageAssignment_1_1(), "rule__TemplateFile__PackageAssignment_1_1");
					put(grammarAccess.getTemplateFileAccess().getImportsAssignment_2(), "rule__TemplateFile__ImportsAssignment_2");
					put(grammarAccess.getTemplateFileAccess().getParamsAssignment_3(), "rule__TemplateFile__ParamsAssignment_3");
					put(grammarAccess.getTemplateFileAccess().getBodyAssignment_4(), "rule__TemplateFile__BodyAssignment_4");
					...
					put(grammarAccess.getBlockStmtAccess().getStatementsAssignment_1_0_0(), "rule__BlockStmt__StatementsAssignment_1_0_0");
					put(grammarAccess.getBlockStmtAccess().getStatementsAssignment_1_0_1(), "rule__BlockStmt__StatementsAssignment_1_0_1");
					put(grammarAccess.getBlockStmtAccess().getStatementsAssignment_1_1_0(), "rule__BlockStmt__StatementsAssignment_1_1_0");
					put(grammarAccess.getBlockStmtAccess().getStatementsAssignment_1_1_1(), "rule__BlockStmt__StatementsAssignment_1_1_1");
					put(grammarAccess.getExpressionStmtAccess().getBodyAssignment(), "rule__ExpressionStmt__BodyAssignment");
					put(grammarAccess.getForStmtAccess().getParamAssignment_1(), "rule__ForStmt__ParamAssignment_1");
					put(grammarAccess.getForStmtAccess().getSourceAssignment_3(), "rule__ForStmt__SourceAssignment_3");
					put(grammarAccess.getForStmtAccess().getBodyAssignment_4(), "rule__ForStmt__BodyAssignment_4");
					put(grammarAccess.getIfStmtAccess().getIfbodiesAssignment_1(), "rule__IfStmt__IfbodiesAssignment_1");
					put(grammarAccess.getIfStmtAccess().getIfbodiesAssignment_2_1(), "rule__IfStmt__IfbodiesAssignment_2_1");
					put(grammarAccess.getIfStmtAccess().getElsebodyAssignment_3_1_1(), "rule__IfStmt__ElsebodyAssignment_3_1_1");
					put(grammarAccess.getIfStmtBodyAccess().getConditionAssignment_0(), "rule__IfStmtBody__ConditionAssignment_0");
					put(grammarAccess.getIfStmtBodyAccess().getBodyAssignment_1(), "rule__IfStmtBody__BodyAssignment_1");
					put(grammarAccess.getTextStmtStmtAccess().getTextAssignment(), "rule__TextStmtStmt__TextAssignment");
					put(grammarAccess.getTextStmtExpAccess().getTextAssignment(), "rule__TextStmtExp__TextAssignment");
