...
import org.xtext.builddsl.ui.highlighting.FileInterpreter;
import org.xtext.builddsl.ui.highlighting.Segment;
      ...
      for (final Segment seg : segments) {
        {
          ...
          if (_equals) {
            ...
            acceptor.addPosition(_offset, _length, BuildHighlightingConfiguration.FILE_SEGMENT_UNKNOWN);
          } else {
            ...
            if (_exists) {
              ...
              acceptor.addPosition(_offset_1, _length_1, BuildHighlightingConfiguration.FILE_SEGMENT_PRESEND);
            } else {
              int _offset_2 = seg.getOffset();
              String _name_3 = seg.getName();
              int _length_2 = _name_3.length();
              acceptor.addPosition(_offset_2, _length_2, BuildHighlightingConfiguration.FILE_SEGMENT_ABSENT);
            }
          }
        }
      }
