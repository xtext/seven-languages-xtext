...
public class BuildHighlightingConfiguration extends XbaseHighlightingConfiguration {
  ...
  public void configure(final IHighlightingConfigurationAcceptor acceptor) {
    ...
    acceptor.acceptDefaultHighlighting(BuildHighlightingConfiguration.FILE_SEGMENT_PRESEND, "Existing File", _presentFile);
    TextStyle _absentFile = this.absentFile();
    acceptor.acceptDefaultHighlighting(BuildHighlightingConfiguration.FILE_SEGMENT_ABSENT, "Non-Existing File", _absentFile);
    TextStyle _unknownFile = this.unknownFile();
    acceptor.acceptDefaultHighlighting(BuildHighlightingConfiguration.FILE_SEGMENT_UNKNOWN, "File with Undetermined Existence", _unknownFile);
