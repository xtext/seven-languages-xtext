...
public class BuildDSLJvmModelInferrer extends AbstractModelInferrer {
  ...
  protected void _infer(final BuildFile element, final IJvmDeclaredTypeAcceptor acceptor, final boolean isPreIndexingPhase) {
        ...
        public void apply(final JvmGenericType it) {
          ...
          final Procedure1<JvmGenericType> _function = new Procedure1<JvmGenericType>() {
              public void apply(final JvmGenericType it) {
                ...
                JvmConstructor _constructor = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toConstructor(element, _function);
                BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmConstructor>operator_add(_members, _constructor);
                ...
                for (final Parameter param : _filter) {
                  {
                    ...
                    JvmField _field = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toField(param, _name, type, _function_1);
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmField>operator_add(_members_1, _field);
                  }
                }
              }
            };
          final JvmGenericType data = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toClass(element, _plus, _function);
          EList<JvmMember> _members = it.getMembers();
          BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmGenericType>operator_add(_members, data);
          EList<JvmMember> _members_1 = it.getMembers();
          JvmTypeReference _newTypeRef = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(element, Void.TYPE);
          final Procedure1<JvmOperation> _function_1 = new Procedure1<JvmOperation>() {
              public void apply(final JvmOperation it) {
                EList<JvmFormalParameter> _parameters = it.getParameters();
                JvmTypeReference _newTypeRef = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(element, String.class);
                JvmTypeReference _addArrayTypeDimension = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.addArrayTypeDimension(_newTypeRef);
                JvmFormalParameter _parameter = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toParameter(element, "args", _addArrayTypeDimension);
                ...
                final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
                    public void apply(final ITreeAppendable it) {
                      ...
                      _builder_1.append("System.out.println(\"Build \'");
                        ...
                        for (final Parameter dec_1 : params) {
                          {
                            ...
                            BuildDSLJvmModelInferrer.this._typeReferenceSerializer.serialize(_elvis, element, it);
                      ...
                      _append_10.newLine();
                      JvmTypeReference _newTypeRef = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(element, String.class);
                      JvmTypeReference _newTypeRef_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(element, Set.class, _newTypeRef);
                      BuildDSLJvmModelInferrer.this._typeReferenceSerializer.serialize(_newTypeRef_1, element, it);
                      it.append(" tasks = ");
                      JvmType _findDeclaredType = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(Sets.class, element);
                      ...
                      for (final Task dec_3 : tasks) {
                        {
                          ...
                          String _methodNameExecute = BuildDSLJvmModelInferrer.this.getMethodNameExecute(dec_3);
                      ...
                      JvmType _findDeclaredType_1 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(Throwable.class, element);
          ...
          JvmOperation _method = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toMethod(element, "main", _newTypeRef, _function_1);
          BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmOperation>operator_add(_members_1, _method);
          EList<Declaration> _declarations = element.getDeclarations();
          Iterable<Task> _filter = Iterables.<Task>filter(_declarations, Task.class);
          for (final Task task : _filter) {
            {
              ...
              JvmTypeReference _newTypeRef_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(task, Void.TYPE);
              final Procedure1<JvmOperation> _function_2 = new Procedure1<JvmOperation>() {
                  public void apply(final JvmOperation it) {
                    EList<JvmFormalParameter> _parameters = it.getParameters();
                    JvmTypeReference _newTypeRef = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(data);
                    JvmTypeReference _newTypeRef_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(element, Procedure1.class, _newTypeRef);
                    JvmFormalParameter _parameter = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toParameter(task, "init", _newTypeRef_1);
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
                    it.setStatic(true);
                    final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
                        public void apply(final ITreeAppendable it) {
                          ...
                          for (final Task dependency : _findDependentTasks) {
                            ...
                            String _methodNameExecute = BuildDSLJvmModelInferrer.this.getMethodNameExecute(dependency);
              ...
              JvmOperation _method_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toMethod(task, _methodName, _newTypeRef_1, _function_2);
              BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmOperation>operator_add(_members_2, _method_1);
              EList<JvmMember> _members_3 = it.getMembers();
              String _methodNameExecute = BuildDSLJvmModelInferrer.this.getMethodNameExecute(task);
              JvmTypeReference _newTypeRef_2 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(task, Void.TYPE);
              final Procedure1<JvmOperation> _function_3 = new Procedure1<JvmOperation>() {
                  public void apply(final JvmOperation it) {
                    ...
                    EList<JvmFormalParameter> _parameters = it.getParameters();
                    JvmTypeReference _newTypeRef = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(data);
                    JvmFormalParameter _parameter = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toParameter(task, "it", _newTypeRef);
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
                    EList<JvmFormalParameter> _parameters_1 = it.getParameters();
                    JvmTypeReference _newTypeRef_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(task, Boolean.TYPE);
                    JvmFormalParameter _parameter_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toParameter(task, "log", _newTypeRef_1);
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters_1, _parameter_1);
                    final Procedure1<ITreeAppendable> _function = new Procedure1<ITreeAppendable>() {
                        public void apply(final ITreeAppendable it) {
                          StringConcatenation _builder = new StringConcatenation();
                          _builder.append("try {");
                          ...
                          _append_1.newLine();
                          String _methodNameExecuteImpl = BuildDSLJvmModelInferrer.this.getMethodNameExecuteImpl(task);
                          it.append(_methodNameExecuteImpl);
                          StringConcatenation _builder_2 = new StringConcatenation();
                          _builder_2.append("(it);");
                          ITreeAppendable _append_2 = it.append(_builder_2);
                          _append_2.newLine();
                          JvmType _findDeclaredType = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(TaskState.class, element);
                          it.append(_findDeclaredType);
                          StringConcatenation _builder_3 = new StringConcatenation();
                          ...
                          JvmType _findDeclaredType_1 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(TaskSkippedException.class, element);
                          it.append(_findDeclaredType_1);
                          StringConcatenation _builder_5 = new StringConcatenation();
                          _builder_5.append(" ");
                          _builder_5.append("e) {");
                          ...
                          _increaseIndentation_1.newLine();
                          JvmType _findDeclaredType_2 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(TaskState.class, element);
                          ...
                          JvmType _findDeclaredType_3 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(Throwable.class, element);
                          ...
                          JvmType _findDeclaredType_4 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(TaskState.class, element);
                          it.append(_findDeclaredType_4);
                          StringConcatenation _builder_9 = new StringConcatenation();
                          _builder_9.append(".setMaySkip(false);");
                          ITreeAppendable _append_7 = it.append(_builder_9);
                          _append_7.newLine();
                          JvmType _findDeclaredType_5 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(TaskState.class, element);
                          ...
                          _append_9.newLine();
                          JvmType _findDeclaredType_6 = BuildDSLJvmModelInferrer.this._typeReferences.findDeclaredType(Exceptions.class, element);
              ...
              JvmOperation _method_2 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toMethod(task, _methodNameExecute, _newTypeRef_2, _function_3);
              BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmOperation>operator_add(_members_3, _method_2);
              EList<JvmMember> _members_4 = it.getMembers();
              String _methodNameExecuteImpl = BuildDSLJvmModelInferrer.this.getMethodNameExecuteImpl(task);
              JvmTypeReference _newTypeRef_3 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(task, Void.TYPE);
              final Procedure1<JvmOperation> _function_4 = new Procedure1<JvmOperation>() {
                  public void apply(final JvmOperation it) {
                    ...
                    it.setVisibility(JvmVisibility.PROTECTED);
                    EList<JvmFormalParameter> _parameters = it.getParameters();
                    JvmTypeReference _newTypeRef_1 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.newTypeRef(data);
                    JvmFormalParameter _parameter = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toParameter(task, "it", _newTypeRef_1);
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmFormalParameter>operator_add(_parameters, _parameter);
                    XExpression _action = task.getAction();
                    BuildDSLJvmModelInferrer.this._jvmTypesBuilder.setBody(it, _action);
                  }
                };
              JvmOperation _method_3 = BuildDSLJvmModelInferrer.this._jvmTypesBuilder.toMethod(task, _methodNameExecuteImpl, _newTypeRef_3, _function_4);
              BuildDSLJvmModelInferrer.this._jvmTypesBuilder.<JvmOperation>operator_add(_members_4, _method_3);
            }
          }
        }
      };
  ...
  public void infer(final EObject element, final IJvmDeclaredTypeAcceptor acceptor, final boolean isPreIndexingPhase) {
    if (element instanceof BuildFile) {
      _infer((BuildFile)element, acceptor, isPreIndexingPhase);
      return;
