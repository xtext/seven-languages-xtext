...
* generated by Xtext
*/
package org.guicecon.modules.ui.contentassist.antlr;
...
public class GuiceModulesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.guicecon.modules.ui.contentassist.antlr.internal.InternalGuiceModulesParser createParser() {
		org.guicecon.modules.ui.contentassist.antlr.internal.InternalGuiceModulesParser result = new org.guicecon.modules.ui.contentassist.antlr.internal.InternalGuiceModulesParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleAccess().getGroup_5_2(), "rule__Module__Group_5_2__0");
					...
					put(grammarAccess.getBindingAccess().getGroup_3_1(), "rule__Binding__Group_3_1__0");
					put(grammarAccess.getKeyAccess().getGroup(), "rule__Key__Group__0");
					put(grammarAccess.getAnnotationRefAccess().getGroup(), "rule__AnnotationRef__Group__0");
					...
					put(grammarAccess.getModuleAccess().getNameAssignment_4(), "rule__Module__NameAssignment_4");
					put(grammarAccess.getModuleAccess().getMixinsAssignment_5_1(), "rule__Module__MixinsAssignment_5_1");
					put(grammarAccess.getModuleAccess().getMixinsAssignment_5_2_1(), "rule__Module__MixinsAssignment_5_2_1");
					put(grammarAccess.getModuleAccess().getBindingsAssignment_7(), "rule__Module__BindingsAssignment_7");
					put(grammarAccess.getBindingAccess().getOverrideAssignment_0(), "rule__Binding__OverrideAssignment_0");
					put(grammarAccess.getBindingAccess().getFromAssignment_2(), "rule__Binding__FromAssignment_2");
					put(grammarAccess.getBindingAccess().getToAssignment_3_0_1(), "rule__Binding__ToAssignment_3_0_1");
					put(grammarAccess.getBindingAccess().getToInstanceAssignment_3_1_1(), "rule__Binding__ToInstanceAssignment_3_1_1");
					put(grammarAccess.getKeyAccess().getAnnotationAssignment_0(), "rule__Key__AnnotationAssignment_0");
					put(grammarAccess.getKeyAccess().getTypeAssignment_1(), "rule__Key__TypeAssignment_1");
					put(grammarAccess.getAnnotationRefAccess().getAnnotationAssignment_1(), "rule__AnnotationRef__AnnotationAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.guicecon.modules.ui.contentassist.antlr.internal.InternalGuiceModulesParser typedParser = (org.guicecon.modules.ui.contentassist.antlr.internal.InternalGuiceModulesParser) parser;
