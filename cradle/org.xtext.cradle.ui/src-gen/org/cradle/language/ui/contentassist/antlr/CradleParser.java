...
* generated by Xtext
*/
package org.cradle.language.ui.contentassist.antlr;
...
public class CradleParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.cradle.language.ui.contentassist.antlr.internal.InternalCradleParser createParser() {
		org.cradle.language.ui.contentassist.antlr.internal.InternalCradleParser result = new org.cradle.language.ui.contentassist.antlr.internal.InternalCradleParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTaskAccess().getAlternatives_2_0(), "rule__Task__Alternatives_2_0");
					put(grammarAccess.getTaskReferenceAccess().getAlternatives(), "rule__TaskReference__Alternatives");
					...
					put(grammarAccess.getTaskAccess().getGroup_2_0_0(), "rule__Task__Group_2_0_0__0");
					...
					put(grammarAccess.getTaskReferenceAccess().getReferenceAssignment_0(), "rule__TaskReference__ReferenceAssignment_0");
					put(grammarAccess.getTaskReferenceAccess().getSoftReferenceAssignment_1(), "rule__TaskReference__SoftReferenceAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.cradle.language.ui.contentassist.antlr.internal.InternalCradleParser typedParser = (org.cradle.language.ui.contentassist.antlr.internal.InternalCradleParser) parser;
			typedParser.entryRuleCradleFile();
