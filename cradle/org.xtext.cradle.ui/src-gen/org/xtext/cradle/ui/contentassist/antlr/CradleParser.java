...
* generated by Xtext
*/
package org.xtext.cradle.ui.contentassist.antlr;
...
public class CradleParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.cradle.ui.contentassist.antlr.internal.InternalCradleParser createParser() {
		org.xtext.cradle.ui.contentassist.antlr.internal.InternalCradleParser result = new org.xtext.cradle.ui.contentassist.antlr.internal.InternalCradleParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getNavigationLiteralAccess().getGroup(), "rule__NavigationLiteral__Group__0");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getRightOperandAssignment_1_1_0_1(), "rule__XMemberFeatureCall__RightOperandAssignment_1_1_0_1");
					...
					put(grammarAccess.getNavigationLiteralAccess().getValueAssignment_1(), "rule__NavigationLiteral__ValueAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.cradle.ui.contentassist.antlr.internal.InternalCradleParser typedParser = (org.xtext.cradle.ui.contentassist.antlr.internal.InternalCradleParser) parser;
