 ...
 * @generated
 */
public class CradleSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        CradleFile cradleFile = (CradleFile)theEObject;
        T result = caseCradleFile(cradleFile);
      ...
      case CradlePackage.DECLARATION:
      {
   ...
   * @generated
   */
  public T caseCradleFile(CradleFile object)
  {
    return null;
  }
