...
public class CradleSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == CradlePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case CradlePackage.TASK_REFERENCE:
				if(context == grammarAccess.getTaskReferenceRule()) {
					sequence_TaskReference(context, (TaskReference) semanticObject); 
					return; 
				}
				else break;
			}
	...
	/**
	 * Constraint:
	 *     (reference=[Task|ID] | softReference=STRING)
	 */
	protected void sequence_TaskReference(EObject context, TaskReference semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (name=ValidID (dependsOn+=TaskReference dependsOn+=TaskReference*)? action=XBlockExpression)
	 */
