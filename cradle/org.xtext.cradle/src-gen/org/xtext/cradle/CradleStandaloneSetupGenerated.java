...
public class CradleStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.cradle.CradleRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.cradle.org/language/Cradle")) {
		EPackage.Registry.INSTANCE.put("http://www.cradle.org/language/Cradle", org.xtext.cradle.cradle.CradlePackage.eINSTANCE);
	}
