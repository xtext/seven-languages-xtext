...
entryRuleCradleFile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCradleFileRule()); }
	 iv_ruleCradleFile=ruleCradleFile 
	 { $current=$iv_ruleCradleFile.current; } 
	 EOF 
;

// Rule CradleFile
ruleCradleFile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleNavigationLiteral returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getNavigationLiteralRule()); }
	 iv_ruleNavigationLiteral=ruleNavigationLiteral 
	 { $current=$iv_ruleNavigationLiteral.current; } 
	 EOF 
;

// Rule NavigationLiteral
ruleNavigationLiteral returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
