 ...
 * <ul>
 *   <li>{@link org.xtext.scripting.scripting.impl.ScriptImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.scripting.scripting.impl.ScriptImpl#getMain <em>Main</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScriptImpl extends MinimalEObjectImpl.Container implements Script
{
  ...
  public NotificationChain basicSetMain(XBlockExpression newMain, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ScriptingPackage.SCRIPT__MAIN, oldMain, newMain);
  ...
  public void setMain(XBlockExpression newMain)
  {
    if (newMain != main)
    {
      ...
      if (main != null)
        msgs = ((InternalEObject)main).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ScriptingPackage.SCRIPT__MAIN, null, msgs);
      if (newMain != null)
        msgs = ((InternalEObject)newMain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ScriptingPackage.SCRIPT__MAIN, null, msgs);
      msgs = basicSetMain(newMain, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ScriptingPackage.SCRIPT__MAIN, newMain, newMain));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ScriptingPackage.SCRIPT__MAIN:
