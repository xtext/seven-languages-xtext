...
/**
 * Manual modifications go to {org.guicecon.modules.GuiceModulesRuntimeModule}
 */
...
public abstract class AbstractGuiceModulesRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/guicecon/modules/GuiceModules.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.guicecon.modules.GuiceModules");
	}
	...
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.guicecon.modules.services.GuiceModulesGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.parseTreeConstructor.ParseTreeConstructorFragment
	public Class<? extends org.eclipse.xtext.parsetree.reconstr.IParseTreeConstructor> bindIParseTreeConstructor() {
		return org.guicecon.modules.parseTreeConstruction.GuiceModulesParsetreeConstructor.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.guicecon.modules.parser.antlr.GuiceModulesParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.guicecon.modules.parser.antlr.GuiceModulesAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.guicecon.modules.parser.antlr.internal.InternalGuiceModulesLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.guicecon.modules.parser.antlr.internal.InternalGuiceModulesLexer> provideInternalGuiceModulesLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.guicecon.modules.parser.antlr.internal.InternalGuiceModulesLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.guicecon.modules.parser.antlr.internal.InternalGuiceModulesLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.guicecon.modules.validation.GuiceModulesJavaValidator> bindGuiceModulesJavaValidator() {
		return org.guicecon.modules.validation.GuiceModulesJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.guicecon.modules.formatting.GuiceModulesFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.guicecon.modules.jvmmodel.GuiceModulesJvmModelInferrer.class;
	}
