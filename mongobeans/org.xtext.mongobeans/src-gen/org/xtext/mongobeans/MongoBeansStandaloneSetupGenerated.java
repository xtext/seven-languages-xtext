...
public class MongoBeansStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.mongobeans.MongoBeansRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/xtext/mongobeans/MongoBeans")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/xtext/mongobeans/MongoBeans", org.xtext.mongobeans.mongoBeans.MongoBeansPackage.eINSTANCE);
	}
